...
class ClipsControllerTest < ActionController::TestCase
  ...
  test "should create clip" do
    assert_difference('Clip.count') do
      post :create, clip: { duration: @clip.duration, episode_id: @clip.episode_id, image_url: @clip.image_url, start_time: @clip.start_time, user_id: @clip.user_id }
    end
  ...
  test "should update clip" do
    patch :update, id: @clip, clip: { duration: @clip.duration, episode_id: @clip.episode_id, image_url: @clip.image_url, start_time: @clip.start_time, user_id: @clip.user_id }
    assert_redirected_to clip_path(assigns(:clip))
  end
